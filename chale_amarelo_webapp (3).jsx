    ...
    () => [
      {
        ...
        image: "/mnt/data/Captura de tela 2026-03-29 152809.png",
      },
      {
        title: "Área gourmet",
        image: "/mnt/data/Captura de tela 2026-03-29 152839.png",
      },
      {
        title: "Suíte confortável",
        image: "/mnt/data/Captura de tela 2026-03-29 152910.png",
      },
      {
        title: "Piscina à noite",
        image: "/mnt/data/Captura de tela 2026-03-29 152936.png",
      },
      {
        title: "Quarto climatizado",
        image: "/mnt/data/Captura de tela 2026-03-29 152951.png",
      },
      {
        title: "Ambiente interno",
        image: "/mnt/data/Captura de tela 2026-03-29 153035.png",
      },
      {
        title: "Fachada do Chalé",
        image: "/mnt/data/Captura de tela 2026-03-29 153121.png",
      },
    ],
    []
  );
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 md:px-8">
          <button type="button" onClick={goToHome} className="flex min-w-0 items-center gap-3 text-left">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-black/5 sm:h-14 sm:w-14">
              <img src="/mnt/data/chale.jpg" alt="Logo Chalé Amarelo" className="h-full w-full object-contain" />
            </div>
              ...
              <div className="order-1 md:order-2">
                ...
                <div className="hidden gap-4 md:grid md:grid-cols-2">
                  <div className="overflow-hidden rounded-[2rem] shadow-lg md:col-span-2">
                    <img src="/mnt/data/Captura de tela 2026-03-29 152809.png" alt="Piscina do Chalé Amarelo" className="h-[390px] w-full object-cover" />
                  </div>
                  <div className="overflow-hidden rounded-[2rem] shadow-md">
                    <img src="/mnt/data/Captura de tela 2026-03-29 152839.png" alt="Área gourmet do Chalé Amarelo" className="h-56 w-full object-cover" />
                  </div>
                  <div className="overflow-hidden rounded-[2rem] shadow-md">
                    <img src="/mnt/data/Captura de tela 2026-03-29 152910.png" alt="Quarto do Chalé Amarelo" className="h-56 w-full object-cover" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid gap-5 md:grid-cols-[1fr_0.9fr] md:gap-8">
            ...
            <div className="space-y-5">
              ...
              <div className="overflow-hidden rounded-[2rem] bg-white shadow-sm ring-1 ring-black/5">
                <img src="/mnt/data/Captura de tela 2026-03-29 153121.png" alt="Fachada do Chalé Amarelo" className="h-72 w-full object-cover" />
                <div className="p-5">
